...
from .model_util import AltDualResidBlock, init_weights

class AltSecondaryResidModel(nn.Module):
    def __init__(self, config):
        ...
        self.dual_blocks = nn.ModuleList([
            AltDualResidBlock(config, layer) for layer in range(config.n_dual_blocks)
        ])
